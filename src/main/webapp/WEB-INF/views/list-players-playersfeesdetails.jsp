...
<div id="root">
		<div id="getplayersbyfeesdetails">
			<form:form action="add" method="post" modelAttribute="getplayers">
				 <div>
		...
		<table>
			...
			<tbody>
				<c:forEach var="feesDetails" items="${feesdetails}">
					<tr>
						<td>${allplayersfeesdetails.paidDate}</td>
						<td>${allplayersfeesdetails.playerId}</td>
						<td>${allplayersfeesdetails.amount}</td>
						<td>${allplayersfeesdetails.remarks}</td>
						<td>${allplayersfeesdetails.recieptNumber}</td>
